 ...
 */
package demos.rpc.server.impl;

import java.io.IOException;
import java.util.Map;

import demos.rpc.RpcException;
import demos.rpc.RpcProto.ErrorReason;
import demos.rpc.RpcProto.Request;
import demos.rpc.RpcProto.Response;
import demos.rpc.client.RpcControllerImpl;
...
public class RpcIoHandler extends IoHandlerAdapter {
	...
	private final static Logger logger = LoggerFactory.getLogger(RpcIoHandler.class);
	...
	/**
	 * @see org.apache.mina.core.service.IoHandlerAdapter#messageReceived(org.apache.mina.core.session.IoSession, Object)
	 */
	@Override
	...
	/**
	 * @see org.apache.mina.core.service.IoHandlerAdapter#exceptionCaught(org.apache.mina.core.session.IoSession, Throwable)
	 */
	@Override
	public void exceptionCaught(IoSession session, Throwable cause)
			throws Exception {
		logger.warn("RPC Server Error", cause);
		Response.Builder builder = Response.newBuilder().setError(String.valueOf(cause));
